...
public class CS2420Class {
	...
	/**
	 * Adds the students specified by the input file to the collection of students
	 * in CS 2420.
	 * 
	 * Assumes a very strict file format: -- first line: FirstName LastName
	 * (u0123456) userName@domainName -- second line: assignment scores, separated
	 * by blank spaces -- third line: exam scores, separated by blank spaces --
	 * fourth line: lab scores, separated by blank spaces -- fifth line: quiz
	 * scores, separated by blank spaces -- sixth line ... : repeat of lines 1-5 for
	 * another student
	 * 
